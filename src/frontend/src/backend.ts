...
export class Backend implements backendInterface {
    ...
    async addModule(arg0: bigint, arg1: string, arg2: bigint): Promise<void> {
    ...
    async addQuestion(arg0: bigint, arg1: bigint, arg2: string, arg3: Array<string>, arg4: bigint, arg5: string, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addQuote(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getQuestionsByModule(arg0: bigint): Promise<Array<Question>> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuestionsByModule(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isAdminPasswordCorrect(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
